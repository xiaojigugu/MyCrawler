...
public class WriteMoreAdapter extends RecyclerView.Adapter<WriteMoreAdapter.MyViewHolder> {
    private Context context;
    private int resId;
    private BiqugeUrl url;
    private List<BeanBookInfo.DataBean.SameUserBooksBean> list;

    public WriteMoreAdapter(Context context, BeanBookInfo bookInfo, int resId) {
        this.context = context;
        this. list = bookInfo.getData().getSameUserBooks();
        this.resId = resId;
        url = new BiqugeUrl();
    }
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onItemClickListener!=null){
                    onItemClickListener.onClick(myViewHolder.itemView,myViewHolder.getAdapterPosition());
                }
            }
        });
    }
